...
var Api$1 = function (_ApiHandler) {
    inherits(Api$$1, _ApiHandler);

    function Api$$1() {
        var csfrtoken = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '123456789';
        classCallCheck(this, Api$$1);

        var _this = possibleConstructorReturn(this, (Api$$1.__proto__ || Object.getPrototypeOf(Api$$1)).call(this, ENDOMONDO_URL, [new DefaultResponseProcessor(EndomondoApiException)]));
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                _context3.next = 3;
                                return this.get(this.getWorkoutsApiUrl('history', null, userId), _extends({}, filter, after instanceof DateTime ? { after: this.getDateString(after) } : {}, before instanceof DateTime ? { before: this.getDateString(before) } : {}, fromDuration instanceof Duration ? { fromDuration: fromDuration.as('seconds') } : {}, toDuration instanceof Duration ? { fromDuration: toDuration.as('seconds') } : {}));
...
var MobileApi = function (_Api) {
    ...
    function MobileApi() {
        ...
        return possibleConstructorReturn(this, (MobileApi.__proto__ || Object.getPrototypeOf(MobileApi)).call(this, ENDOMONDO_MOBILE_URL, [new DefaultResponseProcessor(EndomondoApiException)], {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 3;
                                return this.post('auth' + Api.convertParametersToUrl(options));
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 3:
                                ...
                                _context2.next = 6;
                                return this.request('track' + Api.convertParametersToUrl(options), 'POST', {
                                    body: gzippedBody
                                });
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 5:
                                ...
                                return _context3.abrupt('return', this.request('api/workout/post' + Api.convertParametersToUrl(options), 'POST', {
                                    body: gzippedBody
                                }));
