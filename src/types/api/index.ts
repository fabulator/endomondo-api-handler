import { Point as SourcePoint } from './Point';
import { User as SourceUser } from './User';
import { Workout as SourceWorkout } from './Workout';
...
export type Workout = SourceWorkout;
